...
marcos_velasco = Dev.create(name: "Marcos Velasco", experience: rand(1..10), workplace: "Co")
michael_jester = Dev.create(name: "Michael Jester", experience: rand(1..10), workplace: "Co")
mike_causey = Dev.create(name: "Mike Causey", experience: rand(1..10), workplace: "Co")
paul_nicholsen = Dev.create(name: "Paul Nicholsen", experience: rand(1..10), workplace: "Co")
shannon = Dev.create(name: "Shannon", experience: rand(1..10), workplace: "Co")
shawn_alxander = Dev.create(name: "Shawn Alexander", experience: rand(1..10), workplace: "Co")
solomon = Dev.create(name: "Solomon", experience: rand(1..10), workplace: "Co")
steve_pesce = Dev.create(name: "Steve Pesce", experience: rand(1..10), workplace: "Co")
su = Dev.create(name: "Su", experience: rand(1..10), workplace: "Co")
matine = Dev.create(name: "Matine", experience: rand(1..10), workplace: "Co")
tien_phan = Dev.create(name: "Tien Phan", experience: rand(1..10), workplace: "Co")
zara = Dev.create(name: "Zara", experience: rand(1..10), workplace: "Co")
